...
var Dropdown = function(_Component) {
  ...
  function Dropdown2() {
    ...
    _this.selectItemOnEnter = function(e) {
      ...
      var shouldSelect = import_keyboard_key3.default.getCode(e) === import_keyboard_key3.default.Enter || !search && import_keyboard_key3.default.getCode(e) === import_keyboard_key3.default.Spacebar;
      if (!shouldSelect) {
        return;
      }
      e.preventDefault();
  ...
  Dropdown2.getAutoControlledStateFromProps = function getAutoControlledStateFromProps(nextProps, computedState, prevState) {
    ...
    var shouldComputeSelectedIndex = !(0, import_shallowequal2.default)(prevState.__value, computedState.value) || !isEqual_default(getKeyAndValues(nextProps.options), getKeyAndValues(prevState.__options));
